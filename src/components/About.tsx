...
const About = () => {
  ...
  return (
    <section
      ref={aboutRef}
      id="about"
      className="relative py-24 md:py-28 bg-[#f9f9f9] overflow-hidden scroll-mt-24"
    >
      {/* Floating Particles */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="about-grid grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Card 1 */}
          <div className="about-card bg-[#ffffff] rounded-2xl p-8 shadow-card hover:shadow-elegant transition-smooth group relative z-10">
